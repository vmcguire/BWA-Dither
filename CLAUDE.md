# BWA-Dither — read before doing anything

> ✅ **This is the CANONICAL home for BWA-Dither.** All serious DSP, IP, and
> process for this plugin live **here**, in `~/Developer/BWA-Dither/`. Author here — always.
>
...
> changes. This file deliberately holds only what is specific to BWA-Dither; every
...
4. **`docs/MARKET-PAIN-AND-ATTACKS.md`** — the row for **BWA-Dither**; internalize the pain + attack before any DSP.
...
Then cut a GitHub Release here (`vmcguire/BWA-Dither`) and attach the notarized `BWA-Dither.vst3`.
