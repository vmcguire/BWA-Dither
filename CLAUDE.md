...
> Do all work in the monorepo: **`~/Developer/bwa-fx-ecosystem/BWA-Dither/`**
...
```bash
git subtree push --prefix=BWA-Dither git@github.com:vmcguire/BWA-Dither.git main
```

Then cut a GitHub Release in this mirror and attach the notarized `BWA-Dither.vst3`.
