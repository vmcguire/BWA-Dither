...
TPDF dither + noise shaping + auto-bit-depth detection + streaming-aware presets.
...
BWA-Dither is visible dither. Visual indicator showing dither activity. Auto-bit-depth detection — knows what the destination wants. Streaming-aware presets (different curves for 16-bit vs 24-bit destinations).
...
BWA-Dither ships on **two surfaces** — same DSP, different UI:
...
[Releases](https://github.com/vmcguire/BWA-Dither/releases). Build from
